...
UNITTEST_SUITE_BEGIN(TestChecks)
{
    UNITTEST_FIXTURE(fixture)
    {
        ...
        UNITTEST_TEST(checkEqualsWithStringsFailsOnDifferentStrings)
        {
            ...
            char        txt2[] = "Hallo";
            TestResults results;
            checkEqual(results, txt1, txt2, "", "", 0, FixtureAllocator);
        ...
        UNITTEST_TEST(checkEqualsWithStringsWorksOnContentsNonConstNonConst)
        {
            ...
            TestResults       results;
            checkEqual(results, p1, p2, "", "", 0, FixtureAllocator);
        ...
        UNITTEST_TEST(checkEqualsWithStringsWorksOnContentsWithALiteral)
        {
            char const* const p1 = txt1;
            TestResults       results;
            checkEqual(results, "Hello", p1, "", "", 0, FixtureAllocator);
            CHECK_EQUAL(0, results.getFailureCount());
        }
        ...
        UNITTEST_TEST(checkEqualFailureIncludesCheckExpectedAndActual)
        {
            ...
            checkEqual(results, 1, something, "", "", 0, FixtureAllocator);
        ...
        {
            TestResults results;
            checkClose(results, 3.001f, 3.0f, 0.1f, "", "", 0, FixtureAllocator);
            CHECK_EQUAL(0, results.getFailureCount());
        }
        ...
        {
            TestResults results;
            checkClose(results, 3.12f, 3.0f, 0.1f, "", "", 0, FixtureAllocator);
            CHECK_EQUAL(1, results.getFailureCount());
        }
        ...
        {
            TestResults results;
            checkClose(results, 0.1f, 0.1f, 0, "", "", 0, FixtureAllocator);
            CHECK_EQUAL(0, results.getFailureCount());
        }
        ...
        UNITTEST_TEST(checkCloseWithNaNFails)
        {
            ...
            TestResults results;
            checkClose(results, 3.0f, nan, 0.1f, "", "", 0, FixtureAllocator);
            CHECK_EQUAL(1, results.getFailureCount());
        }
        ...
        UNITTEST_TEST(checkCloseWithNaNAgainstItselfFails)
        {
            ...
            bitpattern = 0xFFFFFFFF;
            TestResults results;
            checkClose(results, nan, nan, 0.1f, "", "", 0, FixtureAllocator);
            CHECK_EQUAL(1, results.getFailureCount());
        }
        ...
        UNITTEST_TEST(checkCloseFailureIncludesCheckExpectedAndActual)
        {
            ...
            checkClose(results, expected, actual, 0.01f, "", "", 0, FixtureAllocator);
        ...
        UNITTEST_TEST(checkCloseFailureIncludesTolerance)
        {
            RecordingReporter reporter;
            TestResults       results(&reporter);
            checkClose(results, 2, 3, 0.01f, "", "", 0, FixtureAllocator);
        ...
        UNITTEST_TEST(checkArrayEqualTrue)
        {
            ...
            checkArrayEqual(results, array, array, 3, "", "", 0, FixtureAllocator);
            CHECK_EQUAL(0, results.getFailureCount());
        }
        ...
        UNITTEST_TEST(checkArrayEqualFalse)
        {
            ...
            checkArrayEqual(results, array1, array2, 3, "", "", 0, FixtureAllocator);
            CHECK_EQUAL(1, results.getFailureCount());
        }
        ...
        UNITTEST_TEST(CheckArrayCloseTrue)
        {
            ...
            checkArrayClose(results, array1, array2, 3, 0.02f, "", "", 0, FixtureAllocator);
            CHECK_EQUAL(0, results.getFailureCount());
        }
        ...
        UNITTEST_TEST(CheckArrayCloseFalse)
        {
            ...
            float const array1[3] = {1.0f, 1.5f, 2.0f};
            float const array2[3] = {1.01f, 1.51f, 2.01f};
            checkArrayClose(results, array1, array2, 3, 0.001f, "", "", 0, FixtureAllocator);
            CHECK_EQUAL(1, results.getFailureCount());
        }
    }
}
